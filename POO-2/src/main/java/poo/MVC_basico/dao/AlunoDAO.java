...
public class AlunoDAO {
    ...
    public List<Aluno> listar() {
        ...
        try {
            ...
            while (rs.next()) {
                alunos.add(new Aluno(rs.getInt("aluno_id"), rs.getString("nome")));
            }
    ...
    public void atualizar(Aluno aluno) {
        String sql = "UPDATE tb_aluno SET nome = ? WHERE aluno_id = ?";
    ...
    public void excluir(Aluno aluno) {
        String sql = "DELETE FROM tb_aluno WHERE aluno_id = ?";
    ...
    public Aluno buscarPorId(int id) {
        String sql = "SELECT * FROM tb_aluno WHERE aluno_id = ?";
